...
export const segments: Segment[] = [
  ...
  {
    slug: 'nonprofits',
    label: 'For Christian nonprofits',
    h1: 'Show your impact, grow your donors, do more with less.',
    sub: 'Donation-optimised websites, donor platforms, automation and AI for Christian charities and NGOs.',
    pains: ['Real impact that’s hard to show', 'Donor data that’s a mess', 'Manual grant and impact reporting', 'A website that doesn’t convert donors', 'A big mission on a limited budget'],
    builds: [
      { name: 'Websites', href: '/services/websites', line: 'Donation-optimised sites that tell your impact story.' },
      { name: 'Apps & portals', href: '/services/web-mobile-apps', line: 'Donor, beneficiary and volunteer platforms.' },
      { name: 'Automation', href: '/services/automation', line: 'Donation → receipt → CRM → thank-you, automatically.' },
      { name: 'AI agents', href: '/services/ai-agents', line: 'Grant-drafting and reporting assistance.' },
    ],
    foundationHook: true,
    seoTitle: 'Website & software for Christian nonprofits',
    seoDesc: 'Donation-optimised websites, donor management, automation and AI for Christian charities and NGOs.',
  },
  {
    slug: 'business',
    label: 'For business & startups',
    h1: 'A serious technical partner — fast, senior, and AI-native.',
    sub: 'Custom software, apps, AI agents and automation for mission-driven and ambitious commercial teams.',
    pains: ['An idea but no technical partner', 'Manual ops capping your growth', 'You need an MVP fast, done right', 'You want AI in your product, done responsibly', 'Agencies that are slow and template-y'],
    builds: [
      { name: 'Custom software', href: '/services/custom-software', line: 'Bespoke platforms, APIs, internal tools and MVPs.' },
      { name: 'Apps & software', href: '/services/web-mobile-apps', line: 'SaaS, portals and mobile apps that scale.' },
      { name: 'AI agents', href: '/services/ai-agents', line: 'Copilots and customer-service agents that do real work.' },
      { name: 'Automation', href: '/services/automation', line: 'Automate the manual work capping your growth.' },
    ],
    foundationHook: false,
    seoTitle: 'Custom software, MVP & AI development studio',
    seoDesc: 'Custom software, apps, AI agents and automation for mission-driven and ambitious commercial teams. Senior, fast, AI-native.',
  },
];
