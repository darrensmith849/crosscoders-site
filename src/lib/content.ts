...
export const give = {
  ...
  illustrative: true,
  tiers: [
    { amount: 50000, label: '1 church' },
    { amount: 150000, label: '3 churches' },
    { amount: 250000, label: '5 · goal' },
  ],
};
...
export const fundElements = [
  { amount: 1000, label: 'a kickstart' },
  { amount: 5000, label: 'real momentum' },
...
export const products: Product[] = [
  {
    ...
    faq: [{ q: 'Web app or native mobile?', a: 'We’ll advise — often a fast web app first, native where it earns its place.' }, { q: 'Can it replace our spreadsheets and tools?', a: 'That’s usually the point — one system that fits how you actually work.' }, { q: 'How long does it take?', a: 'It depends on the scope — we’ll map exactly what you need and give you a realistic timeline before we build.' }, { q: 'Do we own it?', a: 'Yes — the code and the design are yours.' }],
