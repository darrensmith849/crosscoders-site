...
export const products: Product[] = [
  {
    ...
    faq: [{ q: 'Web app or native mobile?', a: 'We’ll advise — often a fast web app first, native where it earns its place.' }, { q: 'Can it replace our spreadsheets and tools?', a: 'That’s usually the point — one system that fits how you actually work.' }, { q: 'How long does it take?', a: 'Weeks, not months — we scope it precisely on the first call.' }, { q: 'Do we own it?', a: 'Yes — the code and the design are yours.' }],
